...
{   
   ...
   int opcion; 
   JMenuBar contenedor;
   JMenu mode,edicion,help ;
   JMenuItem standar,scientific,historic,about;
       ...
       JButton jButton30=new JButton("Delete");
       ...
       public ProyectoCalculadora(String nombre)
        {
          ...
          public void  iniciarControles()
          {
              ...
              //creando las item
              standar =new JMenuItem("Standar");
              scientific =new JMenuItem("Scientific");
              historic =new JMenuItem("Historic");
           ...
           //para los menus
           standar.addActionListener(this);
 ...
 {
	new ProyectoCalculadora("Calculator");
  }
// iniciar implements ActionListener  para los eventos
	  ...
	  b=Float.parseFloat(jTextField1.getText());
		  ...
		  {
                    JOptionPane.showMessageDialog(null,"\tDiseño Orientado a Objetos"+"\n"+"\tJuan Pablo Calcara");
		  }
		  ...
		  //visualizo calculadora estandar
		 if(e.getSource()==standar)
		  {
		 ...
		 else    //visualizo calculadora cientifica
